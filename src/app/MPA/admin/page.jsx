import DevAdmin from "@/Components/production/admin/admin"
import handleGetAllRoutes from "@/function/getRoutes";
import { headers } from "next/headers";

const devItems = ['files', 'configuration', 'sessions', 'appearance', 'usermanagement', 'routemanagement']
...
export default async function Page({ params, searchParams }) {
  ...
  return <DevAdmin backendUrl={returnItem.length > 0 ? returnItem[0]?.value : ""} allRoutes={list1}/>
}